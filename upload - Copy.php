    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            if($i>0){
                ...
                $errorMsg = ''; 
                if(empty($column[1])){ 
                        $errorMsg .= 'Account number mendatory data.'; 
                }
                if(empty($column[2])){ 
                        $errorMsg .= 'Name mendatory data.'; 
                }
                if(empty($column[3])){ 
                        $errorMsg .= 'IC number mendatory data.'; 
                }
                if(empty($column[4])){ 
                        $errorMsg .= 'Phone number mendatory data.'; 
                }
                ...
                if(empty($errorMsg)){
    				...
    				elseif($nrow>0){
    					$type = "error";
    					$message = "Duplicate Phone Number detected and not added";
    				}else{
